...
public class RedisUtils {
  ...
  /**
   * RedisTemplate 使用的是 JdkSerializationRedisSerializer StringRedisTemplate 使用的是
   * StringRedisSerializer 之后可以通过构建redisTemplate来替换序列化的方式
   */
